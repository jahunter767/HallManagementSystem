...
if($_SESSION['isLogged'] === TRUE){
  header('Location: frontend/old-home.php');
}
?>
...
<head>
  ...
  <script src="frontend/scripts/azph_hms.js" type="text/javascript"></script>
  ...
  <link href="frontend/css/az-preston-hall-management-system.webflow.css" rel="stylesheet" type="text/css">
  ...
  <link href="frontend/images/webclip.png" rel="apple-touch-icon">
</head>
<body>  
  <main>
    <?php require_once "frontend/user-select.php";?>
  </main>     
